        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="role" name="role" required>
                        ...
                        <option value="Washer" {{ old('role', $employee->role) == 'Washer' ? 'selected' : '' }}>Washer</option>
                        <option value="Ironer" {{ old('role', $employee->role) == 'Ironer' ? 'selected' : '' }}>Ironer</option>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-text">Upload a new profile photo or ID image (JPG, PNG, GIF)</div>
                    @if($employee->photo)
                        <div class="mt-2">
